...
namespace contact_center_application.graphic_user_interface.manage_graphical_component.tree_view
{
	class ContextMenuForTreeView
	{
		...
		public static void setContextMenuToTreeViewItemCatalog(TreeViewItem item,
			CatalogForSerialization element, int deep)
		{
			if (SettingsData.getRightWrite() == 1)
			{
		...
		public static void setContextMenuForTreeViewCatalog()
		{
			if (SettingsData.getRightWrite() == 1)
			{
		...
		public static void setContextMenuToTreeViewItemFile(TreeViewItem item,
			CatalogForSerialization element)
		{
			...
			if (SettingsData.getRightRead() == 1)
			{
