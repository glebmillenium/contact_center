...
public class Storage {
     ...
     * Хранит основную и дополнительную информацию заявки
     * 
     * @param Map<Integer, Tuple<byte[], byte[]>> 
     */
    private static Map<Integer, Tuple<byte[], byte[]>> 
            queryStorageInformation = new HashMap<Integer, 
                                                    Tuple<byte[], byte[]>>();
    
    /**
     * queryStorageCommand
     * Хранит информацию о типе взаимодействия сервера с клиентом:
     *              false - отправка данных клиенту
     *              true  - прием данных от клиента
    ...
    /**
     * idQuery
     * Вспомогательная информацию необходимая для формирования идентификатора 
     * заявки
     * 
     * @param int
     */
    ...
    /**
     * add
     * Метод добавляет заявку (со всем содержимым) в хранилище
     * Если невозможно добавить заявку в систему (все места заняты, максимальное
    ...
    /**
     * clear
     * Запускает процесс очистки устаревших заявок
     * 
    ...
    /**
     * containsKey
     * Проверяет наличие ключа в хранилище, возвращает результат проверки
     * 
     * @param key
     * @return boolean
     */
    ...
    /**
     * get
     * Создает объект (4-х местный кортеж), который содержим информацию о типе 
     * заявки, названии команды, несущей заявочной информации, дополнительной 
     * информации
     * 
     * @param key
     * @return 
     ...
     * Создает объект (4-х местный кортеж), который содержим информацию о типе 
     * заявки, названии команды, несущей заявочной информации, дополнительной 
     * информации, и удаляет заявку из хранилища
     * 
     * @param key
     * @return 
     */
    ...
    /**
     * remove
     * Удаляет заявку из хранилища по заданному ключу
     * 
     * @param key 
     */
