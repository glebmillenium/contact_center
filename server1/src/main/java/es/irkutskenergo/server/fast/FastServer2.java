 ...
 * @author admin
 */
public class FastServer2 extends Thread {

    private ServerSocket server;
    private int port;
    private boolean canWork = false;

    public FastServer2(int port) throws IOException
    {
        this.port = port;
            ...
            try
            {
                ...
                if (server.isBound())
                {
                    while (this.canWork)
                    {
                        ...
                        SenderSmallData2 senderSmallData = new SenderSmallData2(socket);
                        senderSmallData.process();
