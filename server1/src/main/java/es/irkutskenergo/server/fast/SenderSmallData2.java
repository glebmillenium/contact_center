package es.irkutskenergo.server.fast;
...
public class SenderSmallData2 {
     ...
     */
    private Map<String, Triple<String, String, String>> aliance;
    /**
     ...
     */
    public SenderSmallData2(Socket socket)
    {
        super();
    ...
    {
        new ReceiveData2(this.socket, response.getBytes()).process();
    ...
    {
        this.commandFromClient = message;
    ...
    private String getFileInString(String way)
    {
        ...
        {
            Logger.getLogger(SenderSmallData2.class.getName()).log(Level.SEVERE,
                    null, ex);
        }
        return s;
    }
